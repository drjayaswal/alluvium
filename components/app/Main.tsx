      ...
      <section className="relative z-10 w-full max-w-5xl">
        ...
        >
          <div className="flex -ml-4 items-center text-fuchsia-600">
            ...
            <h1 className="text-xl mb-7.25 md:text-[23px] font-black uppercase tracking-tighter text-white">
              Hello<span className="text-white/50">{user.email.split("@")[0]}</span>
            </h1>
          </div>
          <p className="text-white/50 font-bold text-xs md:text-sm max-w-4xl leading-relaxed tracking-tight">
            An intelligent architecture for document parsing, machine learning
            integration, and real-time dashboarding
          </p>
        </motion.div>
